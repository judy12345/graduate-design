...
parser.add_argument('--max_iter', type=int, default=400, help='max number of iterations to find adversarial example')
...
parser.add_argument('--save', default='/MOTDataset/COCOdataset/pic_By_myMethod', help='folder to output images and model checkpoints')
...
for file in files:
    ...
    try:
        ...
        for i in range(args.max_iter):
            ...
            # imgp = torch.mul(img, 1 - mask_my) + torch.mul(patch, mask_my)
