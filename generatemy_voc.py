...
picpath='/root/autodl-tmp/first-project/COCOdataset/voc_resize4/'
...
parser.add_argument('--save', default='/root/autodl-tmp/first-project/COCOdataset/voc3', help='folder to output images and model checkpoints')
...
def getmask_my(image, meta, pixels):
    ...
    length = int(500 * 500 * 0.03 / num /1 / 2 / 2)
...
for file in files:
    ...
    try:
        ...
        mask = getmask_my(data['img'], data['img_metas'], pixels)+get_mask(data['img'], data['img_metas'], pixels)
        ...
        for i in range(args.max_iter):
            ...
            loss = loss1 + loss2
            print('Num:{:4d}, Iter:{:4d}, Loss:{:.4f}, LossYOLO:{:.4f}, LossFRCNN:{:.4f}'.format(count, i, loss.item(),
                                                                                                 loss1.item(),
                                                                                                 loss2.item()))
        ...
        if flag == 0:
            ...
            for i in range(150):
                ...
                print(
                    'Num:{:4d}, Iter:{:4d}, Loss:{:.4f}, LossYOLO:{:.4f}, LossFRCNN:{:.4f}, BoxNum:{:.2f}'.format(count, i,
                                                                                                                  loss.item(),
                                                                                                                  loss1.item(),
                                                                                                                  loss4.item(),
                                                                                                                  loss3.item()))
