...
svpicpth='/MOTDataset/COCOdataset/test'
jsonsvpath='/MOTDataset/COCOdataset/resjson/pic_By_oriMethod_By_frcn.json'
parser = argparse.ArgumentParser()
parser.add_argument('--save', default='/MOTDataset/COCOdataset/pic_By_myMethod_By_frcn',
...
def saverespic(out,file,classesName,threshold=0.3):
...
for file in files:
    ...
    # model2.show_result(os.path.join(picpath, file),t,out_file=os.path.join(svpicpth,file),score_thr=0.6)
