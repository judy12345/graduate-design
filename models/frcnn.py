import sys
import os
sys.path.append(os.path.abspath('../frcnn_utils/pytorch-faster-rcnn/lib'))
sys.path.append(os.path.abspath('../frcnn_utils/pytorch-faster-rcnn/tools'))
...
class FRCNN(nn.Module):
    ...
    def forward(self, imgs, bboxes, labels, scale):
        ...
        losses = losses + [object_vanishing_loss]
