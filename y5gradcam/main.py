...
import argparse
import numpy as np
from y5gradcam.models.gradcam import YOLOV5GradCAM
...
parser.add_argument('--img-path', type=str, default='/root/autodl-tmp/first-project/COCOdataset/ppt/ppt4.jpg', help='input image path')
