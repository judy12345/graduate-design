...
import torch
from y5gradcam.models.experimental import attempt_load
from y5gradcam.utils.general import xywh2xyxy
from y5gradcam.utils.datasets import letterbox
import cv2
import time
import torchvision
import torch.nn as nn
from y5gradcam.utils.metrics import box_iou
...
class YOLOV5TorchObjectDetector(nn.Module):
    def __init__(self,
        ...
        # fetch the names
        if names is None:
            print('[INFO] fetching names from voc file')
            self.names = ['__background__','aeroplane', 'bicycle', 'bird', 'boat', 'bottle', 'bus', 'car', 'cat',
